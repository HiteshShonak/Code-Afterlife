      ...
      <div className="relative z-10">
        ...
        <section className="relative flex min-h-[90vh] flex-col items-center justify-center px-6 text-center">
          ...
          >
            ...
            >
              Software <br/>
              <span className="text-transparent bg-clip-text bg-linear-to-r from-amber-200 via-amber-400 to-[#b87333]">Never Dies.</span>
            </motion.h1>
        ...
        <div className="relative border-y border-white/5 bg-black/40 backdrop-blur-3xl py-32 md:py-48">
          ...
          <div className="mx-auto max-w-4xl px-6 flex flex-col gap-32 md:gap-48">
            ...
            <motion.div {...fadeUp} className="flex flex-col md:flex-row items-start gap-8 md:gap-16">
              ...
              <div>
                <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-transparent bg-clip-text bg-linear-to-r from-amber-200 to-[#b87333] mb-6">
                  The Resurrection.
                </h2>
                <p className="text-lg md:text-xl text-white/40 leading-relaxed font-sans max-w-2xl">
        ...
        <section className="relative flex min-h-[60vh] flex-col items-center justify-center px-6 text-center">
          <motion.div {...fadeUp} className="flex flex-col items-center">
            ...
            <div className="mb-10 flex items-center justify-center">
              <div className="h-24 w-px bg-linear-to-t from-amber-500/50 to-transparent" />
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              ...
              >
                <span className="absolute inset-0 bg-linear-to-r from-transparent via-amber-400/10 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000" />
